    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <form id="rent-form" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="rent_image" class="form-label">Upload Note Image</label>
                    <input type="file" class="form-control" id="rent_image" accept="image/*" required>
                </div>
...
function postRentalNote() {
    const file = document.getElementById('rent_image').files[0];
    if (!file) {
